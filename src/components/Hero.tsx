...
const SOCIAL_LINKS: SocialLink[] = [
  {
    href: "https://github.com/edoardo-borsato",
    label: "GitHub",
    external: true,
    icon: (
      <svg
  ...
  {
    href: "mailto:edoardo.borsato93@gmail.com",
    label: "Email",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
    ...
    <section className="py-20 px-6">
      <div className="mx-auto max-w-3xl">
        <h1 className="text-4xl font-bold tracking-tight text-zinc-900 sm:text-5xl dark:text-zinc-50">
          Hey, I&apos;m Edoardo Borsato
        </h1>
        <p className="mt-6 text-lg leading-8 text-zinc-600 dark:text-zinc-400">
          Software Engineer based in Italy. I build backend services, APIs, and
          full-stack applications with a focus on clean, maintainable code. I love
